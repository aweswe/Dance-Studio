  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-20 px-6 md:px-16 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          <div className="text-[10px] tracking-[5px] uppercase text-bl mb-4">Get In Touch</div>
          ...
          <div className="flex flex-col gap-8 mb-12">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-[12px] font-bold tracking-[2px] uppercase mb-2">Address</h4>
                <p className="text-sm text-mu leading-relaxed max-w-sm">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-[12px] font-bold tracking-[2px] uppercase mb-2">Call / WhatsApp</h4>
                <p className="text-sm text-mu mb-2">{ACADEMY.phoneDisplay}</p>
                <a 
                  href={`https://wa.me/${ACADEMY.phone.replace(/[^0-9]/g, '')}`} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-bl text-sm font-semibold hover:underline"
                >
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-[12px] font-bold tracking-[2px] uppercase mb-2">Email</h4>
                <p className="text-sm text-mu">{ACADEMY.email}</p>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[12px] font-bold tracking-[2px] uppercase mb-4">Follow Us</h4>
            <div className="flex gap-4">
              <a href={ACADEMY.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center text-blk hover:bg-bl hover:text-white hover:border-bl transition-all">
              ...
              <a href={ACADEMY.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center text-blk hover:bg-bl hover:text-white hover:border-bl transition-all">
        ...
        <div className="bg-light p-8 md:p-12 rounded-2xl border border-black/5 flex flex-col justify-center">
          ...
          <div className="flex flex-wrap gap-2">
            {NEARBY_AREAS.map((area, idx) => (
              <span key={idx} className="bg-white border border-black/10 text-blk text-[11px] font-semibold tracking-wider uppercase px-3 py-1.5 rounded-full">
                {area}
              </span>
            ))}
          </div>
      ...
      {/* Full Width Map */}
      <section className="h-[500px] w-full bg-off relative">
        <iframe
