    ...
    <Card className="max-w-md mx-auto md:mx-0">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={prevMonth} aria-label="Previous month" className="min-h-11 min-w-11 inline-flex items-center justify-center hover:bg-canvas-muted rounded-md focus-visible:focus-ring active:scale-[0.96]"><ChevronLeft size={20} /></button>
          <button onClick={nextMonth} aria-label="Next month" className="min-h-11 min-w-11 inline-flex items-center justify-center hover:bg-canvas-muted rounded-md focus-visible:focus-ring active:scale-[0.96]"><ChevronRight size={20} /></button>
        </div>
      </div>
