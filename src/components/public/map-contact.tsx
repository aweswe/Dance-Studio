...
export function MapContact() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 bg-white">
      <div className="h-[400px] md:h-auto bg-off relative">
        <iframe
      ...
      <div className="p-12 md:p-20 bg-blk text-white flex flex-col justify-center">
        <div className="text-[10px] tracking-[5px] uppercase text-bll mb-4">Visit Us</div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href={ACADEMY.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-bl hover:border-bl transition-all">
            ...
            <a href={ACADEMY.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-bl hover:border-bl transition-all">
