...
export function SnapCarousel({ children, columns = 4, className }: SnapCarouselProps) {
  return (
    <div
      className={cn(
        'flex gap-4 overflow-x-auto snap-x snap-mandatory overscroll-x-contain no-scrollbar pb-2 scroll-px-0 [scroll-padding-inline:0]',
        columns === 4 &&
